...
ggplot(full_snail_heatmap, aes(x = month_name, y = year, fill = littoraria_count, color = "")) +
  geom_tile() +
  scale_fill_gradient(low = "white", high = "darkgreen", na.value = "#333333") +
  scale_colour_manual(values=NA) +              
  guides(colour = guide_legend("No data", override.aes=list(colour="#333333"))) +
  labs(title = expression(paste(italic("Littoraria "), "Counts")),
       x = "Month",
       y = "Year",
       fill = expression(paste(italic("Littoraria "), "Counts"))) +
  theme_minimal(base_family = "fira condensed") +
